...
";
			...
			<div id='scoreboard' style='float:left;'>
				...
				<style type="text/css">
					#final_consolation_header {
						font-family:leagueGothicRegular;font-size:26px;color:maroon;text-align:center;
					}
					#school_name_container {
						width: 50px;
					}
					#school_name_container p {
				...
				<div class="internal_score_block" style="height:110px;">
					...
					<div id="center_container">
						<p id="vs">vs</p>
						<span class="label label-info" style="margin-top: 8px;margin-left: 18px;float: left;">2:30PM</span>
					</div>
				...
				<div class="internal_score_block" style="height:100px;">
					<h6 id="final_consolation_header">Final</h6>
					<div style="float: left;width: 50px;margin-left: 10px;">	
						<img src="img/blank.gif" id="sas_50px">
						<p style="margin-top: -3px;margin-left: 8px;">SAS</p>
					</div>
					<div style="width: 80px;float: left;text-align: center;">
						<p style="margin-left: 34px;margin-top: 20px;">vs</p>
						<span class="label label-info" style="margin-top: 8px;margin-left: 18px;float: left;">6:00PM</span>
					</div>
					<div style="float: right;width: 50px;margin-right: 10px;">	
						<img src="img/blank.gif" id="isb_50px">
						<p style="margin-top: -3px;margin-left: 11px;">ISB</p>
					</div>					
				</div>
				<?php
					error_reporting(0);
