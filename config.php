...
function ft_settings_external_load() {
  ...
  define("USERNAME", "xyk2"); // Your default username.
  define("PASSWORD", "loldongs"); // Your default password.
  ...
  $ft["settings"]["PERMISSION"]        = 0655; // Permission for uploaded files.
  ...
  $ft["settings"]["FILEBLACKLIST"]     = "ft2.php ft.css config.php config.sample.php LICENSE README.markdown .DS_store .gitignore"; // Specific files that will not be shown.
  $ft["settings"]["FOLDERBLACKLIST"]   = "plugins css locales data"; // Specifies folders that will not be shown. No starting or trailing slashes!
