...
<head>
    ...
    <style type="text/css">
        ...
        .lineuptabs section.current_lineup h3 { background: #eee; cursor: default; }

        .lineuptabs section div {
            position: absolute;
            left: 0;
            z-index: 2;
            width: 100%;
        ...
        .lineuptabs section.current_lineup div { display: block; }
    </style>
		...
		$(function(){
            $('article.lineuptabs section > h3').click(function(){
                $('article.lineuptabs section').removeClass('current_lineup');
                $(this)
                .closest('section').addClass('current_lineup');
            });
        });
    </script>
</head>

<body style='width:650px;margin-left:auto;margin-right:auto;margin-top:20px;'>
	<h1>TAS
		<span style="font-size: 35px;"> vs </span>
		SAS
		<span style="font-size: 20px;">3:30pm - Upper Field</span>
	</h1>
	<div style='margin-top:15px;height:86px;margin-bottom:15px;'>
	...
	<article class="tabs">
        <section class="current">
            ...
            <div style='padding-top:10px;'>
				    <article class="lineuptabs"> <!-- WORK!!!!!!!!!!!!!!!!!!!!!! -->
						<section>
							<h3>Documents</h3>
							<div>
								<p>A documents tab content1</p>
								<p>A documents tab content2</p>
							</div>
						</section>
						<section class="current_lineup">
							<h3>Info</h3>
							<div>
								<p>A info tab content1</p>
								<p>A info tab content2</p>
							</div>
						</section>
						<section>
							<h3>Credentials</h3>
							<div>
								<p>A credentials tab content1</p>
